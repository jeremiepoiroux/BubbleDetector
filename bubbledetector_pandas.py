import json
import pandas
from bubbledetector_stream import *


tweets_data = []
tweets_file = open(file_name + '.json', 'r')  # open the .json file and take only the tweets from it
...
tweets.to_csv(file_name + '.csv')  # export this dataframe to a csv file