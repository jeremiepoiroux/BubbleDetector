...
# plot_scatter(b1, "Nodes colored by containment at distance 1", [min(b1), int(median(b1)), max(b1)])
# plot_scatter(b2, "Nodes colored by containment at distance 2", [min(b2), int(median(b2)), max(b2)])
# plot_scatter(bubbliness, "Nodes colored by openness", [min(bubbliness), int(median(bubbliness)), max(bubbliness)])
# plot_scatter(times_retweeted, "Nodes colored by number of times they were retweeted", [min(times_retweeted), int(median(times_retweeted)), max(times_retweeted)])
# plot_scatter(times_retweet, "Nodes colored by number of times they retweeted", [min(times_retweet), int(median(times_retweet)), max(times_retweet)])
...
def plot_hist(data, title, length, x, y):
    plt.figure(figsize=(400/96, 170/96), dpi=96)
...
# plot_hist(b1, "b1 whole network", len(b1), 1, 20)
# plot_hist(b2, "b2 whole network", len(b2), 1,30)
# plot_hist(bubbliness, "openness ratio whole network", len(bubbliness), 1, 20)
# plot_hist(were_retweeted, "nodes were retweeted whole network", len(were_retweeted), 16, 125)
# plot_hist(have_retweeted, "nodes have retweeted whole network", len(have_retweeted), 5.1, 90)
...
# plot_hist(b1_0, "b1 community 0", len(b1_0), 1, 20)
# plot_hist(b2_0, "b2 community 0", len(b2_0),1,30)
# plot_hist(bubbliness_0, "openness ratio community 0", len(bubbliness_0), 1, 20)
# plot_hist(were_retweeted_0, "nodes were retweeted community 0", len(were_retweeted_0), 16, 40)
...
# plot_hist(b1_1, "b1 community 1", len(b1_1), 1, 20)
# plot_hist(b2_1, "b2 community 1", len(b2_1), 1,30)
# plot_hist(bubbliness_1, "openness ratio community 1", len(bubbliness_1), 1, 20)
# plot_hist(were_retweeted_1, "nodes were retweeted community 1", len(were_retweeted_1), 16, 40)
...
# plot_hist(b1_2, "b1 community 2", len(b1_2), 1, 20)
# plot_hist(b2_2, "b2 community 2", len(b2_2), 1,30)
# plot_hist(bubbliness_2, "openness ratio community 2", len(bubbliness_2), 1, 20)
# plot_hist(were_retweeted_2, "nodes were retweeted community 2", len(were_retweeted_2), 16, 40)
...
# plot_hist(b1_3, "b1 community 3", len(b1_3), 1, 20)
# plot_hist(b2_3, "b2 community 3", len(b2_3), 1,30)
# plot_hist(bubbliness_3, "openness ratio community 3", len(bubbliness_3), 1, 20)
# plot_hist(were_retweeted_3, "nodes were retweeted community 3", len(were_retweeted_3), 16, 40)
...
# plot_hist(b1_4, "b1 community 4", len(b1_4), 1, 20)
# plot_hist(b2_4, "b2 community 4", len(b2_4), 1,30)
# plot_hist(bubbliness_4, "openness ratio community 4", len(bubbliness_4), 1, 20)
# plot_hist(were_retweeted_4, "nodes were retweeted community 4", len(were_retweeted_4), 16, 40)
...
for i in list_friends_radar_d1d2:
    h = ((i[2][0])^2) + ((i[3][0])^2) + ((i[2][1])^2) + ((i[3][1])^2) + ((i[2][2])^2) + ((i[3][2])^2) + ((i[2][3])^2) + ((i[3][3])^2) + ((i[2][4])^2) + ((i[3][4])^2)
    # print(h)
    list_friends_radar_d1d2.append(h)
...
for i in list_friends_radar_d1d2:
    ...
    def pie(a,b,c,d,e,f,g,h,i,j,k,l,m):
            ...
            plt.setp( pie2, width=0.8, edgecolor='white')
